...
answer = input("You are on a dirt road, it has come to an end and you can go lest or right. Which way you like to go? ")
if answer == "left":
    ...
    if answer == "swim":
        ...
        print("You walked for many miles, wan out of water and you lost the game.")
    else:
